...
/* If these 2 are not defined, the corresponding config setting is used */
 ...
 // 需设置contrib-1.4.1\ports\win32\include\lwipopts.h中的"LWIP_DHCP"为1
...
#define LWIP_PORT_INIT_IPADDR(addr)   IP4_ADDR((addr), 172,1,108,49)
#define LWIP_PORT_INIT_GW(addr)       IP4_ADDR((addr), 172,1,109,254)
