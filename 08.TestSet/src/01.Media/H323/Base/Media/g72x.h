/* $Id: g72x.h,v 1.1 2004/04/26 14:57:43 martinm Exp $
   $Log: g72x.h,v $
   Revision 1.1  2004/04/26 14:57:43  martinm
   Initial revision
 */
...
extern int pack_output(unsigned code, int bits, unsigned char *pDataTrack);
