...
public:
	...
	CIndexEntry(const CIndexEntry* pTempEntry)
	{
		IsCopy = TRUE;
		this->IsDefault = pTempEntry->IsDefault;
		this->IndexEntry = new INDEX_ENTRY;
		memset((void*)IndexEntry,0,sizeof(IndexEntry));
		memcpy((void*)IndexEntry,pTempEntry->IndexEntry,sizeof(INDEX_ENTRY));
		CopyFileName(this,(const ATTR_FILE_NAME *)IndexEntry);
	}
