...
*/
		switch (icol)
		{
			case 0: strRes = "文件名"; break;
			case 1: strRes = "大小"; break;
			case 2: strRes = "可利用源“; break;
			case 3: strRes = "完整源"; break;
			case 4: strRes = "类型"; break;
			case 5: strRes = "文件ID"; break;
			case 6: strRes = "艺术家"; break;
			case 7: strRes = "专辑"; break;
			case 8: strRes = "标题"; break;
			case 9: strRes = "长度"; break;
			case 10: strRes = "比特率"; break;
			case 11: strRes = "编码器"; break;
			case 12: strRes = "文件夹"; break;
			case 13: strRes = "已知"; break;
		}
...
//			if (thePrefs.IsExtControlsEnabled())
			...
			str = _T("Yes");//GetResString(IDS_YES);
		}
		if (pbComplete)
			*pbComplete = true;
	}
