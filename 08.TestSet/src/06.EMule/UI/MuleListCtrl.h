...
public:
	...
	int GetItemCount() const { return (int)m_Params.GetCount(); };

	enum ArrowType { arrowDown = IDB_EMULE_BMP_DOWN, arrowUp = IDB_EMULE_BMP_UP,
		arrowDoubleDown = IDB_EMULE_BMP_DOWN2X, arrowDoubleUp = IDB_EMULE_BMP_UP2X };
