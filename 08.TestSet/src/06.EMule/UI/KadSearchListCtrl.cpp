...
//	iml.Create(16,16,theApp.m_iDfltImageListColorFlags|ILC_MASK,0,1);
	iml.Create(16,16,ILC_COLOR24|ILC_MASK,0,1);
...
void CKadSearchListCtrl::Localize()
{
	...
	for (int icol=0;icol<pHeaderCtrl->GetItemCount();icol++) {
		switch (icol) {
			...
			*/
			case colNum: strRes = _T("Number"); break;
			case colKey: strRes = _T("Key"); break;
			case colType: strRes = _T("Type"); break;
			case colName: strRes = _T("Name"); break;
			case colStop: strRes = _T("Status"); break;
			case colResponses: strRes = _T("Responses"); break;
			case colLoad: strRes = _T("Load"); break;
			case colPacketsSent: strRes = _T("Packets Sent"); break;
