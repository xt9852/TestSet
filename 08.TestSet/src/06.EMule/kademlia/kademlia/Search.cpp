...
//	theApp.emuledlg->kademliawnd->searchList->SearchAdd(this);
	Kademlia::CKademlia::GetSearchListCtrl()->SearchAdd(this);
...
//	theApp.emuledlg->kademliawnd->searchList->SearchRem(this);
	Kademlia::CKademlia::GetSearchListCtrl()->SearchRem(this);
/*
...
//	theApp.emuledlg->kademliawnd->searchList->SearchRef(this);
	Kademlia::CKademlia::GetSearchListCtrl()->SearchRef(this);
}
...
//				m_pfileSearchTerms.WriteUInt16(thePrefs.GetPort());
				m_pfileSearchTerms.WriteUInt16(CKademlia::GetPrefs()->GetUdpPort());
...
*/
	...
	CString strAnswer = uAnswer.ToHexString();
	TRACE(_T("ProcessResultKeyword %d %d %s %d %s\n"), m_uSearchID, m_uAnswers, (LPCTSTR)sName, uSize, strAnswer);
		//, (LPCTSTR)sType, (LPCTSTR)sFormat, (LPCTSTR)sArtist, (LPCTSTR)sAlbum, (LPCTSTR)sTitle, uLength, uBitrate, (LPCTSTR)sCodec, uAvailability);
}
