...
;
; VC应用：
;	1，在VC环境中，在“解决方案资源管理器”中选取中此文件
;	2，右击，选“属性”，“自定义生成步骤”，“常规”
;	3，在“命令行”，填入“ml.exe /c /Cx /coff /Fo $(IntDir)%(Filename).obj "%(FullPath)"”
;	4，在“输出”，填入“$(IntDir)%(Filename).obj”
;
;
; #####################################################################################################################
;
...
;
; The integration into other projects than AnyFilms is expressivly encouraged. Feel free to contact me about it.
;
; #####################################################################################################################
